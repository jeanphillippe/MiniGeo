        ...
        conversations: [
            {
                ...
                action: {type: 'followAndMove', target: {x: 12, z: 3}, speed: 0.05,smooth: true}
            },
...
'scout_mike': {
    ...
    conversations: [
        {
            message: "Hola, viajero. ¿Quieres ver una carrera entre Veloz y yo hacia la bandera? Él es rápido, pero yo soy constante.",
            requiresConfirmation: true,
            ...
            action: {
                ...
                onSuccess: {
                    ...
                    target: {x: 13, z: 5},
                    speed: 0.04,
                    message: "Nos preparamos en la línea de salida...",
                    nextAction: {
                        type: 'patrolnpc',
                        npcId: 'guard_tom',
                        patrolType: null,
                        ...
                        nextAction: {
                            ...
                            speed: 0.03,
                            delay: 1200,
                            message: "¡Empezamos! Voy paso a paso, pero nunca me detengo.",
                            nextAction: {
                                type: 'message',
                                message: 'Sigo mi ritmo...',
                                delay: 500,
                                nextAction: {
                                    type: 'patrolnpc',
                                    npcId: 'guard_tom',
                                    message: 'Veloz arranca rapidísimo',
                                    delay: 500,
                                    patrolType: null,
                                    centerX: 13,
                                    centerZ: 9,
                                    ...
                                    nextAction: {
                                        ...
                                        nextAction: {
                                            type: 'message',
                                            message: 'Mientras Veloz descansa, yo sigo avanzando...',
                                            delay: 1500,
                                            nextAction: {
                                                type: 'move',
                                                target: {x: 14, z: 12},
                                                speed: 0.03,
                                                delay: 1000,
                                                message: "La constancia siempre gana.",
                                                nextAction: {
                                                    type: 'patrolnpc',
                                                    npcId: 'guard_tom',
                                                    message: 'Veloz despierta y corre desesperado',
                                                    delay: 1400,
                                                    patrolType: null,
                                                    centerX: 14,
                                                    centerZ: 12,
                ...
                onFailure: {
                    ...
                    target: {x: 13, z: 5},
                    speed: 0.04,
                    message: "Nos preparamos, pero seguirás a Veloz...",
                    nextAction: {
                        type: 'patrolnpc',
                        npcId: 'guard_tom',
                        patrolType: null,
                        ...
                        nextAction: {
                            ...
                            speed: 0.03,
                            delay: 1500,
                            message: "Está bien, yo mantendré mi ritmo constante.",
                            nextAction: {
                                type: 'message',
                                message: 'Avanzo paso a paso mientras Veloz corre...',
                                delay: 500,
                                nextAction: {
                                    type: 'patrolnpc',
                                    npcId: 'guard_tom',
                                    message: 'Veloz corre rapidísimo y se adelanta',
                                    delay: 500,
                                    patrolType: null,
                                    centerX: 13,
                                    centerZ: 8,
                                    ...
                                    nextAction: {
                                        type: 'patrolnpc',
                                        npcId: 'guard_tom',
                                        message: 'Veloz se detiene confiado a descansar',
                                        delay: 1500,
                                        patrolType: 'none',
                                        centerX: 13,
                                        centerZ: 8,
                                        ...
                                        nextAction: {
                                            type: 'message',
                                            message: 'Sigo avanzando mientras él descansa...',
                                            delay: 1500,
                                            nextAction: {
                                                type: 'move',
                                                target: {x: 14, z: 12},
                                                speed: 0.03,
                                                delay: 1000,
                                                message: "Al final, llegué primero. Paso a paso se llega lejos.",
                                                nextAction: {
                                                    type: 'patrolnpc',
                                                    npcId: 'guard_tom',
                                                    message: 'Veloz despierta demasiado tarde',
                                                    delay: 1000,
                                                    patrolType: null,
                                                    centerX: 14,
                                                    centerZ: 12,
...
'guard_tom': {
    ...
    conversations: [
        {
            message: "¡Hola viajero! ¿Quieres ver cómo le gano fácilmente a Donatello en una carrera a la bandera?",
            requiresConfirmation: true,
            ...
            action: {
                ...
                onSuccess: {
                    ...
                    target: {x: 14, z: 5},
                    speed: 0.04,
                    message: "Nos colocamos en la línea de salida...",
                    nextAction: {
                        type: 'patrolnpc',
                        npcId: 'scout_mike',
                        patrolType: null,
                        ...
                        nextAction: {
                            ...
                            nextAction: {
                                            type: 'message',
                                            message: 'Voy tan adelantado que puedo descansar... Zzz...',
                                            delay: 500,
                            nextAction: {
                                type: 'patrolnpc',
                                npcId: 'scout_mike',
                                message: 'Donatello avanza paso a paso',
                                delay: 500,
                                patrolType: null,
                                centerX: 13,
                                centerZ: 8,
                                speed: 0.03,
                                    nextAction: {
                                        type: 'patrolnpc',
                                        npcId: 'scout_mike',
                                        message: 'Donatello sigue avanzando constante',
                                        delay: 1500,
                                        patrolType: null,
                                        centerX: 14,
                                        centerZ: 12,
                                        ...
                                        nextAction: {
                                            type: 'message',
                                            message: 'Donatello llega a la meta',
                                            delay: 1500,
                                            nextAction: {
                                                type: 'move',
                                                target: {x: 14, z: 12},
    ...
    target: {x: 14, z: 5},
    speed: 0.04,
    message: "Nos preparamos, pero seguirás a Donatello...",
    nextAction: {
        type: 'patrolnpc',
        npcId: 'scout_mike',
        patrolType: null,
        ...
        nextAction: {
            ...
            nextAction: {
                type: 'message',
                message: 'Descanso aquí... tengo tiempo de sobra... Zzz...',
                delay: 500,
                nextAction: {
                    type: 'patrolnpc',
                    npcId: 'scout_mike',
                    message: 'Donatello avanza lento pero constante',
                    delay: 500,
                    patrolType: null,
                    centerX: 13,
                    centerZ: 8,
                    ...
                    nextAction: {
                        type: 'patrolnpc',
                        npcId: 'scout_mike',
                        message: 'Donatello pasa y llega a la meta',
                        delay: 1500,
                        patrolType: null,
                        centerX: 14,
                        centerZ: 12,
                        ...
                        nextAction: {
                            type: 'message',
                            message: 'Donatello gana la carrera',
                            delay: 1500,
                            nextAction: {
                                type: 'move',
                                target: {x: 14, z: 12},
...
const STATIC_OBJECT_INSTANCES = [
    ...
    {template: 'singlepine', position: {x: 12, z: 9}},
